class Escenario
{
  ...
  void display()
  {
    ...
    image(fondito,6,y3-288);
    image(fondito,54,y3-288);
    image(fondito,102,y3-288);
    image(fondito,150,y3-288);
    image(fondito,188,y3-288);
    image(fondito,54,y3-336);
    image(fondito,102,y3-336);
    image(fondito,100,y3-384);
    image(fondito,150,y3-336);
    image(up,188,y3-288);
    image(up2,6,y3-288);
    image(torre4,6,y3-336);
    image(torre4,52,y3-384);
    image(torre5,188,y3-336);
    image(torre5,140,y3-384);
    ...
    image(base,x1+1104,y1);
    image(base,x1+1152,y1);
    image(base,x1+1200,y1);
    image(base,x1+1248,y1);
    //Relleno base
    image(debaj,x1,y4);
    ...
    image(debaj,x1+1104,y4);
    image(debaj,x1+1152,y4);
    image(debaj,x1+1200,y4);
    image(debaj,x1+1248,y4);
    ...
    image(rock2,740,595);
    image(rock3,395,590);
    image(rock3,1260,590);
    image(rock2,1160,595);
    //Puerta
    image(dr,85,560);
    //Ventanas

...
PImage  dr,decor1,decor2, decor3, decor4,ctrl, fondo,arb, intent, fondito, menucito,inst,aud,dead;
...
void setup()
{
  ...
  inst= loadImage("assets/PNG/Objects/inst.png");
  aud= loadImage("assets/PNG/Objects/aud.png");
  dead= loadImage("assets/PNG/Objects/dead.png");
  ...
  menucito= loadImage("assets/PNG/Objects/menu.png");
  ...
  enemigo=new Enemigos(random(1500,1800),560);

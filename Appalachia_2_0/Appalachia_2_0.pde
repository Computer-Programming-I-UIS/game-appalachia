...
PImage  dr,decor1,decor2, decor3, decor4,ctrl, fondo,arb, intent, fondito, menucito,mp;
PImage enmy[],fantasma[],bola[],mago[];
int gl,ftm,bl,mg;
boolean pausa=false;
...
void setup()
{
  ...
  cg = minim.loadFile("assets/Cg.wav");
  go = minim.loadFile("assets/go.wav");
 ...
 // bi= loadImage("assets/PNG/Tiles/tile42.png");
  ...
  mp= loadImage("assets/PNG/Objects/mp.png");
